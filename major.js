...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/1028546/pexels-photo-1028546.jpeg?auto=compress&cs=tinysrgb&w=600)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/1530423/pexels-photo-1530423.jpeg?auto=compress&cs=tinysrgb&w=600)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/96622/pexels-photo-96622.jpeg?auto=compress&cs=tinysrgb&w=600)';
    }
    else if (status === 'Snow') {
        ...
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/296234/pexels-photo-296234.jpeg?auto=compress&cs=tinysrgb&w=600)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/1118869/pexels-photo-1118869.jpeg?auto=compress&cs=tinysrgb&w=600)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/5479840/pexels-photo-5479840.jpeg?auto=compress&cs=tinysrgb&w=600)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/845619/pexels-photo-845619.jpeg?auto=compress&cs=tinysrgb&w=600)';
    }

    else {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/2850287/pexels-photo-2850287.jpeg?auto=compress&cs=tinysrgb&w=600)';
    }
}
